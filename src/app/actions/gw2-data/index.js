...
import gw2Api, { readPvpSeason } from '../../services/gw2';
...
export const actions = {
  ...
  FETCH_PVP_SEASON_RESULT: 'FETCH_PVP_SEASON_RESULT',
};
...
export function fetchPvpSeasonSuccess (season) {
  return {
    type: actions.FETCH_PVP_SEASON_RESULT,
    payload: season,
  };
}
...
export function fetchPvpSeasonThunk (id) {
  return (dispatch) => {
    return readPvpSeason(id)
      .then((response) => {
